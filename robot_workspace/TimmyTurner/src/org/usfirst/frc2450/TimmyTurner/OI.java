...
public class OI {
    ...
    public OI() {
        ...
        turnLeftButton.whenPressed(new TurnLeft(0));
        turnRightButton = new JoystickButton(leftJoystick, 15);
        turnRightButton.whenPressed(new TurnRight(0));
        ...
        SmartDashboard.putData("AutoPos0LS", new AutoPos0LS(false));
        SmartDashboard.putData("AutoPos1LF", new AutoPos1LF(false));
        SmartDashboard.putData("AutoPos2LF", new AutoPos2LF(false));
        SmartDashboard.putData("AutoPos2RF", new AutoPos2RF(false));
        SmartDashboard.putData("AutoPos3RF", new AutoPos3RF(false));
        SmartDashboard.putData("AutoPos4RS", new AutoPos4RS(false));
        ...
        SmartDashboard.putData("DefaultAuto", new DefaultAuto(false));
        SmartDashboard.putData("DriveForward", new DriveForward(0));
        ...
        SmartDashboard.putData("TurnLeft", new TurnLeft(0));
        SmartDashboard.putData("TurnRight", new TurnRight(0));
